...
from components.masked_cross_entropy import *
...
def train_tree(config, input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, generate_nums,
	...
	embedded = None
	orig_idx = None
	if config.embedding == 'albert' or config.embedding == 'bart' or config.embedding == 'bert' or config.embedding == 'electra' or config.embedding == 'gpt2' or config.embedding == 'roberta' or config.embedding == 't5' or config.embedding == 'xlnet':   
